...
import { Header, Carousel, Navbar } from '@/layout';
                                        ...
                                        <div className="inline-flex flex-col space-y-1 pl-4 2xl:hidden 3xlc:inline-flex">
                                            ...
                                            <div className="flex flex-row">
                                                <span className="mr-4 flex flex-row items-center text-white">
                                                    <svg stroke="currentColor" fill="white" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="mr-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg> 84.88</span>
                                                <span className="flex flex-row items-center text-white"><svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="mr-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line><line x1="2" y1="12" x2="22" y2="12"></line><line x1="2" y1="7" x2="7" y2="7"></line><line x1="2" y1="17" x2="7" y2="17"></line><line x1="17" y1="17" x2="22" y2="17"></line><line x1="17" y1="7" x2="22" y2="7"></line></svg> 25</span>
                                            </div>
                                            <a href="https://www.youtube.com/watch?v=LHtdKWJdif4" target="_blank" className="w-min cursor-pointer rounded-xl bg-red-500 px-4 py-2 text-white shadow-lg shadow-red-400 transition hover:scale-105 hover:bg-red-600"><svg stroke="currentColor" fill="white" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="16" width="16" xmlns="http://www.w3.org/2000/svg"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></a>
                                        </div>
                                    </div>
